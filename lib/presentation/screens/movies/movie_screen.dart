        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              // Descripción
              SizedBox(
                width: (context.mediaQuery.size.width - 40) * 0.7,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
...
final isFavouriteProvider =
  ...
  final favouriteRepo = ref.watch(favouritesRepositoryProvider);
  return favouriteRepo.isMovieFavourite(movieId);
});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SliverAppBar(
      ...
      actions: [
        IconButton(
            onPressed: () {
              ref.watch(favouritesRepositoryProvider).toggleFavourite(movie);
